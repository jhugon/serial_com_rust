...
impl std::fmt::Display for SerialComError {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match *self {
            ...
            SerialComError::FileReadErr(ref e) => e.fmt(f),
            SerialComError::FileWriteErr(ref e) => e.fmt(f),
...
impl std::error::Error for SerialComError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match *self {
            ...
            SerialComError::FileRead(ref e) => Some(e),
            SerialComError::FileWrite(ref e) => Some(e),
